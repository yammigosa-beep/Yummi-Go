...
export default function WhyChooseUs() {
  const reasons = [
    {
      title: "شبكة واسعة",
      description: "شبكة واسعة من المطابخ ومزوّدي الإعاشة الموثوقين.",
      icon: (
    ...
    {
      title: "أسعار تنافسية",
      description: "أسعار تنافسية نتيجة الربط المباشر وتقليل التكاليف.",
      icon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "معايير الجودة",
      description: "التزام كامل بمعايير الجودة والنظافة.",
      icon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "توفير الوقت",
      description: "توفير الوقت والجهد على إدارة المصانع.",
      icon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "خدمة مستمرة",
      description: "تجربة سلسة وخدمة عملاء مستمرة.",
      icon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="relative group h-full">
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-orange-500 to-orange-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
                  </div>
                </div>
              </motion.div>
            ))}
