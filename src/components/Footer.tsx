  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: "لماذا نحن", href: "#why-choose-us" },
    ...
    },
    {
      title: "الخدمات",
      links: [
        { name: "توفير الوجبات اليومية", href: "#services" },
        { name: "إدارة المطابخ", href: "#services" },
        { name: "خدمات التوصيل", href: "#services" },
        { name: "استشارات غذائية", href: "#services" },
      ]
    },
    {
      title: "تواصل معنا",
      links: [
        { name: "+966 50 123 4567", href: "tel:+966501234567", icon: "phone" },
        { name: "info@yummigo.sa", href: "mailto:info@yummigo.sa", icon: "email" },
        { name: "واتساب", href: "https://wa.me/966501234567", icon: "whatsapp" },
      ]
    }
  ]
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <div className="lg:col-span-1">
                <div className="mb-6">
                  <img src="/LOGO_White.svg" alt="Yummi Go" className="h-12 w-auto mb-4" />
          ...
          <div className="border-t border-white/20">
            <div className="container mx-auto px-4 py-6">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-white/80 font-cairo text-center md:text-right">
                ...
                <div className="flex gap-6 text-sm">
                  <a
                    href="#privacy"
                    className="text-white/80 hover:text-yummi-accent font-cairo transition-colors duration-300"
                  >
                    سياسة الخصوصية
                  </a>
                  <a
